...
public class EmployeeFreeTime {
  ...
  public static List<Interval> employeeFreeTime(List<List<Interval>> schedule) {
    ...
    int[] firstEntryInHeap = heap.peek();
    int indexOfEmp = firstEntryInHeap[1];
    int startValue = firstEntryInHeap[2];
    int previous = schedule.get(indexOfEmp).get(startValue).start;
   ...
   * Example: [[[3, 5], [8, 10]], [[4, 6], [9, 12]], [[5, 6], [8, 10]]]
   * ans = [[6,8]]
   * <p>
   * SOLUTION :
   * min-heap
